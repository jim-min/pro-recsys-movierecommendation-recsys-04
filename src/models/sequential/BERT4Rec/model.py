...
class BERT4Rec(nn.Module):
    def __init__(self, num_user, num_item, hidden_units, num_heads, num_layers, max_len, dropout_rate, device):
        ...
        self.item_emb = nn.Embedding(num_item + 2, hidden_units, padding_idx=0) # padding_idx=0으로 설정하여 mask된 위치는 0벡터로 처리
        ...
        self.out = nn.Linear(hidden_units, num_item + 2, bias=False)
